...
import com.example.auth.security.SecurityFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return  httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET, "/product", "/product/api").permitAll()
                        ...
                        .requestMatchers(HttpMethod.GET, "product/create").permitAll()
